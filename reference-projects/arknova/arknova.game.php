...
class arknova extends Table
{
  use ARK\DebugTrait;
  use ARK\States\SetupTrait;
  use ARK\States\EngineTrait;
  use ARK\States\TurnTrait;
  use ARK\States\BreakTrait;
  ...
  public function getAllDatas()
  {
    ...
    return [
      ...
      'deckCount' => ZooCards::countInLocation('deck'),
      'discardCount' => ZooCards::countInLocation('discard'),
      'buildings' => Buildings::getUiData(),
      'meeples' => Meeples::getUiData(),

      'break' => Globals::getBreak(),
      'maxBreak' => Globals::getMaxBreak(),
      'peaceful' => Globals::isPeaceful(),
      'conservationBonuses' => Globals::getBonusTiles(),
      'maxAppeal' => 25 + Globals::getSoloAppeal(),
      'endOfGame' => Globals::isEndTriggered(),
      'startingAppeal' => Globals::getSoloAppeal(),

      'isMarine' => Globals::isMarineWorld(),
    ];
  }
