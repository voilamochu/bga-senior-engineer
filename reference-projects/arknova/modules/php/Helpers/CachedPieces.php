...
class CachedPieces extends DB_Manager
{
  ...
  public static function where($field, $value): Collection
  {
   ...
   */
  public static function getSelectWhere($id = null, $location = null, $state = null): Collection
  {
   ...
   */
  final static function checkLocation(string|array &$location, bool $like = false)
  {
    if (is_null($location)) {
   ...
   */
  final static function checkId(mixed &$id, bool $like = false)
  {
    if (is_null($id)) {
  ...
  final static function checkIdArray(array $arr)
  {
    if (is_null($arr)) {
   ...
   */
  final static function checkState(null|int|string $state, bool $canBeNull = false)
  {
   ...
   */
  final static function checkPosInt(null|int|string $n)
  {
   ...
   */
  public static function get(int|string|array $id, bool $raiseExceptionIfNotEnough = true): mixed
  {
   ...
   */
  public static function getFiltered(int|null $pId, string $location = null, string $type = null): Collection
  {
   ...
   *************************************
   ************************************/
  public static function setState(string|int $id, int $state)
  {
