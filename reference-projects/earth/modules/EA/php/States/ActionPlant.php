...
trait GameStatesTrait
{
    ...
    private function plantActionPlanCardWithPossiblePayement(
        ...
        if ($overrideCard !== null && $overrideCard->cardId != $cardId) {
            ...
            if (
                ...
                throw new \BgaUserException(clienttranslate('You cannot plant this card over the selected terrain'));
            }
        }
    ...
    public function stActionPlantSpecialGain()
    {
        ...
        $this->gamestate->setPlayersMultiactive($specialGainPlayerIds, '', true /*Exclusive*/);
