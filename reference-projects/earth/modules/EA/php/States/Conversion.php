...
trait GameStatesTrait
{
    public function convertPlay()
    {
        ...
        if (!$cardMgr->playerCanPlayConversion($playerId)) {
            throw new \BgaUserException(clienttranslate('You do not have enough sprouts to convert'));
        }
    ...
    public function convertUseSeed()
    {
        ...
        if (!$this->playerCanUseSeed($playerId)) {
            throw new \BgaUserException(clienttranslate('You do not have seed to convert'));
        }
    ...
    public function convertCreateSeed()
    {
        ...
        if (!$this->playerCanCreateSeed($playerId)) {
            throw new \BgaUserException(clienttranslate('You do not have leaf or sprouts to convert'));
        }
