...
$machinestates = [
    ...
    STATE_PLAYER_SETUP_ID => [
        ...
        "description" => clienttranslate('Other players must choose initial cards'),
        "descriptionmyturn" => clienttranslate('${you} must choose initial cards'),
    ...
    STATE_ACTION_PLANT_ADDITIONAL_ID => [
        ...
        "description" => clienttranslate('All players have an additional plant action'),
        "descriptionmyturn" => clienttranslate('${you} have an additional plant action ${mainActionId}'),
        "type" => "multipleactiveplayer",
        "args" => "argsEarthDefaultMultiActive",
    ...
    STATE_ACTION_PLANT_ADDITIONAL_CARD_ID => [
        ...
        "description" => clienttranslate('Other players must play'),
        "descriptionmyturn" => clienttranslate('${you} have an additional plant action or skip ${mainActionId}'),
        "type" => "private",
        "args" => "argsPlantActionPlant",
        "possibleactions" => [
            'plantActionPlanCard',
    ...
    STATE_END_TURN_EVENT_CHOOSE_ID => [
        ...
        "description" => clienttranslate('Other players must play'),
        "descriptionmyturn" => clienttranslate('${you} must: ${endTurnEventChoose}'),
        "type" => "private",
