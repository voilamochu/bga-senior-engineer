        ...
        return declare("bgagame.earth", [
            ...
            showWelcomeMessage() {
                ...
                this.showInformationDialog(_('Welcome to Earth!'), [
                    _('${startb}If you do not want to see this message again, close it and disable the related option at the bottom of the page.${endb}'),
                    _('You can control the display of many aspects of the game in the option panel at the bottom of the page. You can also control the display of the cards in your hand with the ${caret} icon on the top left of the page.'),
                    '',
                    _('Card Help'),
