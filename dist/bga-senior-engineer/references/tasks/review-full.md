...
required_checklists:
  ...
  - assets/checklists/pre-release.json
required_examples:
...
phases:
  ...
  - name: undo_animations
    rules:
      ...
      - references/rules/animations.json
...
Before declaring this phase complete:
1. Run assets/checklists/pre-review.json. Verify all items pass.
2. Run assets/checklists/pre-release.json. Verify all items pass.
...
- [ ] assets/checklists/pre-release.json passes all items
...
1. Run assets/checklists/pre-release.json
