...
- references/rules/migration.json — Load when handling Dojo-to-ES module conversion. Check MIGR-006.

## Workflow

### Step 1: Load the Canonical Example

Load assets/examples/client-manager-example.json to see the standard client-side Manager pattern.
...
If handling Dojo-specific migration patterns, load references/rules/migration.json and check MIGR-006.
