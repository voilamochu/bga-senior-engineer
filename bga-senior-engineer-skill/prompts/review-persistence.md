...
- rules/undo-replay.json — Load when reviewing undo log table design. Check UNDO-001 through UNDO-005.
...
If reviewing undo log table design, load rules/undo-replay.json and check UNDO-001 through UNDO-005 for correct log table structure, LIFO reversal, and checkpoint boundaries.
